...
weight: 1
aliases:
    - getting-started/content/tutorials/launching-a-nodejs-app/set-up-sectionctl/
---
...
```
wget https://github.com/section/sectionctl/releases/download/v1.8.0/sectionctl-v1.8.0-linux-amd64.tar.gz
tar zxvf sectionctl-v1.8.0-linux-amd64.tar.gz
```
...
Next: [set up an example Node.js app]({{< relref "/tutorials/launching-a-nodejs-app/set-up-an-example-nodejs-app.md" >}}).
