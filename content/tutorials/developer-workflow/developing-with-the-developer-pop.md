...
weight: 3
aliases:
  - /developer-workflow/tutorials/developing-with-the-developer-pop/
...
{{< figure src="/docs/images/dev/download-cert.png" title="Download Local Root Certificate" >}}
...
#### Further Reading
For a guide on [troubleshooting common Developer PoP issues]({{< relref "how-tos/developer-workflow/troubleshoot-developerpop.md" >}}).

For a guide on setting up [DevPoP with a local server]({{< relref "how-tos/developer-workflow/dev-pop-with-local-server.md" >}}).
